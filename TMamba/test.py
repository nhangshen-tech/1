...
def test(args):
    ...
    style_paths = args.style_test_dir
    content_paths = args.content_test_dir
    if not os.path.exists(args.output_dir):
        os.mkdir(args.output_dir)

    print("Starting...")
    print(f"Content images: {args.content_test_dir}, number of images: {len(os.listdir(args.content_test_dir))}")
    print(f"Style images: {args.style_test_dir}, number of images: {len(os.listdir(args.style_test_dir))}")
